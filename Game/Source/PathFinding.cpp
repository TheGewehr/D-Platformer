...
PathFinding::PathFinding(bool startEnabled) : Module(), map(NULL), lastPath(DEFAULT_PATH_LENGTH), width(0), height(0)
{
	active = startEnabled;
...
// ----------------------------------------------------------------------------------
// Actual A* algorithm: return number of 
// s in the creation of the path or -1 ----
// ----------------------------------------------------------------------------------
